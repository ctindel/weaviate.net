...
namespace Weaviate.Client.Tests.V1.Graph.Query.Builder;
...
public class GetTests : TestBase
{
	...
	{
		var query = new Get { Collection = COLLECTION_NAME_PIZZA, Fields = new[] { new Field { Name = "name" } } };
	...
	{
		var query = new Get { Collection = COLLECTION_NAME_PIZZA, Limit = 2, Fields = new[] { new Field { Name = "name" } } };
	...
	public void GetWithLimitAndOffset()
	{
		var query = new Get
		{
			Collection = COLLECTION_NAME_PIZZA, Limit = 2, Offset = 0, Fields = new[] { new Field { Name = "name" } }
		};
	...
	public void GetWithLimitAndAfter()
	{
		var query = new Get
		{
			Collection = COLLECTION_NAME_PIZZA, Limit = 2, After = "00000000-0000-0000-0000-000000000000", Fields = new[] { new Field { Name = "name" } }
		};
